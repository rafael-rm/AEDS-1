...
sao n  ̃ umeros informados pelo usu  ́ ario.
*/
...
int main()
{
    int numero1, numero2, i, j, divisoes = 0, total_primos = 0, auxiliar;
    do
    {
    ...
    if (numero1 < numero2)
    {
        ...
        printf("\n\nO total de numeros primos no intervalo de %d a %d e de: %d\n", numero1, numero2, total_primos);
        return 0;
    }
    return 0;
}
